...
their authoritative public sources: elevation from the USGS 3D Elevation
Program (3DEP) 1 arc-second (30-m) product; vegetation from the LANDFIRE
LF2025 Existing Vegetation Type layer [28]; roads from the U.S. Census
Bureau's TIGER/Line dataset (all road classes, 2024 vintage); and the
species distribution range from the USFWS 2015 Status Review current range
[32]. Every acquisition writes a provenance manifest (source URL,
publication date, checksum) alongside the data.
...
found no pairwise correlation more extreme than |0.6|. We then generated 12
...
generated available points. The models that included ruggedness, slope,
...
below, with conifer most strongly avoided. Leks were less likely to be
...
calibrated across deciles. Predicted probability at used leks was
...
![Figure 4. Predicted probabilities of greater sage-grouse lek occurrence in
