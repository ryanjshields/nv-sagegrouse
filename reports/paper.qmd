...
included aspect, slope, curvature, and ruggedness. Curvature is total
...
quantile classification (Fig. 8). Because the used:available ratio is fixed
...
values tracked observed use rates across deciles (Fig. 7) — internally
