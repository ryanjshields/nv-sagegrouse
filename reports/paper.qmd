...
CI −1.28 – −0.76), and on level ground lacking measurable slope (β = −1.20).
Grassland cover was favored over the shrubland reference (β = 0.44, 85% CI
0.16 – 0.72), while conifer cover held fewer than five of 718 lek sites and,
...
roads (β = 0.10, 85% CI 0.03 – 0.17) and, more weakly, closer to unpaved
...
0.80 ± 0.04) and its predictions were insensitive to post-2018 vegetation
change at lek sites. The analysis is implemented as a fully scripted, openly
...
All fifteen models entered a single AICc ranking; we note the road-class
...
(VRM; β = −1.02, 85% CI −1.28 – −0.76); mean VRM at used lek sites was
...
(Flat; β = −1.20, 85% CI −1.49 – −0.91): leks occupy gentle, but not
featureless, terrain. Relative to shrubland, grassland cover was selected
(β = 0.44, 85% CI 0.16 – 0.72); exotic herbaceous cover trended positive
...
paved roads than availability (β = 0.10, 85% CI 0.03 – 0.17), while the
association with unpaved roads and vehicular trails was negative but did
not exclude zero (β = −0.09, 85% CI −0.19 – 0.01; lek sites averaged 896 m
...
(S2 Table). Externally, the surface correlated positively with the USGS
