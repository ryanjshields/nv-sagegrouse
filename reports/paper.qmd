...
and less likely to occur on steeper slopes (β = −1.19, 85% CI −1.34 – −1.05)
and on rugged terrain measured by the Vector Ruggedness Measure (β = −1.02,
85% CI −1.27 – −0.76); herbaceous cover types were favored over conifer,
which was strongly avoided. The averaged model discriminated well (AUC =
...
on steeper slopes (β = −1.19, 85% CI −1.34 – −1.05) and on rugged terrain
(VRM; β = −1.02, 85% CI −1.27 – −0.76): used lek sites averaged VRM 0.00046
...
<!-- Figure 4 (prediction map) inserted by pipeline once the scoring pass
completes: v4/figs/prediction_map_v4.png -->
...
Roads did not significantly affect the probability of leks occurring in our
study area, even with all road classes — dominated by unimproved and local
roads — included in the distance surface. The type of road (and the level
of anthropogenic disturbance) could still play a role in the relationship
between a given road and the probability of a lek occurring [13]: unpaved
and remotely located roads can host successful lek sites while busier,
noisier roads may be inhospitable to lekking activity. We recommend that
future studies model road classes separately.
