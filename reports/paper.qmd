...
occurrence. The averaged model discriminated well between used and
available sites (AUC = 0.80; 5-fold cross-validation AUC 0.79 ± 0.01), and
predicted probabilities were well calibrated across deciles.
